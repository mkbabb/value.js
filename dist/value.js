...
class n {
  ...
  coalesce(e, t = !1) {
    return e == null ? this : k.includes(this.unit) ? this : t ? (this.unit ??= e.unit, this.superType ??= e.superType, this.subProperty ??= e.subProperty, this.property ??= e.property, this.targets ??= e.targets, this) : new n(
      o(this.value),
      this.unit ?? e.unit,
