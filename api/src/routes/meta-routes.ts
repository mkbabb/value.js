...
export const ROUTES: readonly RouteDef[] = [
    ...
    { method: "POST", path: "/palettes/:slug/remix", auth: "session", group: "Palettes", summary: "Remix from a source palette" },
    ...
    { method: "GET", path: "/palettes/:slug/diff", auth: "none", group: "Palettes", summary: "Atom diff against a version" },
