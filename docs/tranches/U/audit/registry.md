...
- pins `@mkbabb/value.js '^3.1.0'` (`../keyframes.js/package.json:269`, VERIFIED) → a 4.0.0 cut strands **TWO** peer floors, not one; **keyframes must co-widen its pin at the cut** (a co-migration R-4 omitted).
