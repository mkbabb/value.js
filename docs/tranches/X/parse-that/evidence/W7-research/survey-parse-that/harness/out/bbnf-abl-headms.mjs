...
var Parser = class _Parser {
  ...
  mapState(fn) {
    const mapState = (state) => {
      ...
      return fn(state, { offset: oldOffset, value: oldValue });
    };
    return new _Parser(
      mapState,
