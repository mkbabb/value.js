...
function stripCaseWorkaround(text) {
  return text.replace(/\/((?:\\.|\[(?:\\.|[^\]])*\]|[^/\\\n[])+)\/i\b/g, (lit, body) => "/" + body.replace(/\[([a-zA-Z])([a-zA-Z])\]/g, (cls, a, b) => a !== b && a.toLowerCase() === b.toLowerCase() ? (STRIPPED.count++, a.toLowerCase()) : cls) + "/i");
}
  ...
  if (p === void 0) {
    ...
    if (t.compiled === void 0) {
      ...
      if (true) {
        ...
        t.compiled = e;
        VALUE = e.value;
      } else t.compiled = { rule: compileKernel(t.ast, opts).rule, value };
    }
