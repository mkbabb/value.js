...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/grammar.ts
var grammar_exports = {};
__export(grammar_exports, {
  ...
  serializeCssColor: () => serializeCssColor,
  serializeKeyframeSelector: () => serializeKeyframeSelector,
  splitTopLevel: () => splitTopLevel,
  success: () => success
});

// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/foundation/result.ts
var ok = (value) => ({ ok: true, value });
var err = (error) => ({ ok: false, error });

// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/color/model.ts
var SPACE_SCHEMA = {
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/color/anchors.ts
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/named-colors.ts
...
var chan = (percentScale, angle2 = false) => (token) => channelToken(token, percentScale, angle2);
...
function parseFunctionalColor(source, name, body) {
  ...
  if (lower === "color" && components.length === 4) {
    ...
    const numeric2 = channelTriple(rest, [chan(1), chan(1), chan(1)]);
    if (numeric2 === null) return failure(source);
    const [x, y, z] = numeric2;
    if (rawSpace === "srgb") {
    ...
    switch (space) {
      case "xyz":
        return colorResult(source, xyz(...numeric2, alpha));
      case "srgb-linear":
        return colorResult(source, linearSrgb(...numeric2, alpha));
      case "display-p3":
        return colorResult(source, displayP3(...numeric2, alpha));
      case "a98-rgb":
        return colorResult(source, a98Rgb(...numeric2, alpha));
      case "prophoto-rgb":
        return colorResult(source, prophotoRgb(...numeric2, alpha));
      case "rec2020":
        return colorResult(source, rec2020(...numeric2, alpha));
      default:
...
function serializeKeyframeSelector(selector) {
  ...
  return selector.offset === void 0 ? selector.name : `${selector.name} ${format(selector.offset * 100)}%`;
}
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/timeline.ts
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/rules.ts
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/serialize.ts
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/syntax.ts
...
// ../../../../private/var/folders/ld/20j4p2791k5_90_0ccgx2txm0000gr/T/value-js-w7-judge/retired-src/src/css/stylesheet.ts
...
function descriptorText(declaration) {
  return declaration === void 0 ? ok(void 0) : serializeCssValue(declaration.value);
}
function parseScopePrelude(source) {
  ...
  return {
    ...
    ...limit === void 0 ? {} : { limit: splitTopLevel(limit, ",") }
  };
}
...
function parseFunctionPrelude(source) {
  ...
  if (functionName === void 0 || rawBody === void 0) {
  ...
  for (const row of body ? splitTopLevel(body, ",") : []) {
    ...
    if (parameterName === void 0) return failure(row, "css_syntax", ["custom function parameter"]);
