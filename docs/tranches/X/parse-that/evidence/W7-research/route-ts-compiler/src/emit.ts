...
import type { Action, CompileOptions } from "./compile.js";

type Mode = "v" | "r";
type Emitted = { rule(name: string): (s: string, i: number) => number; value(): unknown; source: string };

export function emitGrammar(ast: AST, opts: CompileOptions = {}): Emitted {
