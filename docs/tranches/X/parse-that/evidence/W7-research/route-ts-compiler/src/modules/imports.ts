...
import type { RecoverDirective, PrettyDirective, ProductionRule } from "../../vendor/bbnf-0.1.4/types.js";
...
export type { AST } from "../../vendor/bbnf-0.1.4/types.js";
...
export function mergeModuleAST(
    registry: ModuleRegistry,
    entryPath: string,
): import("../../vendor/bbnf-0.1.4/types.js").AST {
    const merged = new Map<string, ProductionRule>() as import("../../vendor/bbnf-0.1.4/types.js").AST;
