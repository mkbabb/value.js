...
let __CUR = ""; function decode_json_string_to_arena(sp) { const t = __CUR.slice(sp.start + 1, sp.end - 1); return t.indexOf("\\") === -1 ? t : JSON.parse(__CUR.slice(sp.start, sp.end)); }
...
const __map1 = (__lit0) !== null ? 0 : null;
  ...
  const __body = __map1;
  return __body !== null ? ({ tag: "null", value: __body }) : null;
}
...
return __map5; })()); }
  ...
  return __body !== null ? ({ tag: "bool", value: __body }) : null;
}
...
const __map8 = __input !== null ? decode_json_string_to_arena(__input) : null;
  ...
  const __body = __map8;
  return __body !== null ? ({ tag: "string", value: __body }) : null;
}
...
if (___20 === null) return null;
  ...
  return __body !== null ? ({ tag: "object", value: __body }) : null;
}
...
if (___32 === null) return null;
  ...
  return __body !== null ? ({ tag: "array", value: __body }) : null;
}
...
if (__v37 === null) return null;
  ...
  return __body !== null ? ({ tag: "pair", value: __body }) : null;
}
...
return __iw39 !== null ? ({ tag: "number", value: __iw39 }) : null; })()); break;
    default: break;
  }
}
...
export function parse(input) {
  __CUR = input; const s = createState(input);
