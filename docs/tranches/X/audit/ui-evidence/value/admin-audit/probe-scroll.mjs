...
await page.screenshot({ path: `${OUT}probe-390-after-wheel.png` });
...
await page.screenshot({ path: `${OUT}probe-1440-after-wheel.png` });
writeFileSync(`${OUT}probe-scroll.json`, JSON.stringify(out, null, 2));
