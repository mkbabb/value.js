...
const MANIFEST_SCHEMA_PATH = "docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6.schema.json";
const SHARD_SCHEMA_PATH = "docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6-shard.schema.json";
const REPLAY_COMMAND = "node docs/tranches/V/apotheosis/pi/denominator/tools/occurrence-owner-v6/launch.mjs --source-root \"$PINNED_CSSWG_ROOT\" --keyframes-root \"$KEYFRAMES_PRIMARY_ROOT\" --output \"$OCCURRENCE_OWNER_V6_OUTPUT\"";
...
function makeManifest(evidence, tables, attestation, counterfixtures) {
    const manifest = {
        schema_version: "value.pi.full-source-occurrence-owner-formation/v6",
        date: "2026-07-22",
        ...
        validation: {
            ...
            semantic_shard_regeneration: "PASS_CONTEXTS_CARRIERS_OPERATIONS_REFERENCES_OWNER_SCOPE",
