...
const PINNED = Object.freeze({
    ...
    v6Artifact: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6.json", "13c212e58c45f685e2a7cb5a1bd6a63c1f964a318a2701e2912edfdeb414564d", 20149],
    v6ManifestSchema: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6.schema.json", "b3a7131d643b469bdce4b1538ae1946d5cec19b970de71a2026078c9262f53ba", 11617],
    v6ShardSchema: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6-shard.schema.json", "23eaa9f7f7895c4c7c47005e56f06300cf4097a4b3d8ccbbd61c332e15c6dc48", 13811],
    v6Receipt: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v6-formation-2026-07-22.md", "019d1e1c4f988ec5046700ad44cf82fd6e90df1ffc19984181fed21ddec8097f", 8717],
    v6ChallengeA: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v6-challenge-a.md", "54b847e2054302f6940eb609807c75e73145cbf82027fedd0c16e5d1dfca6008", 12626],
    v6ChallengeB: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v6-challenge-b.md", "bf9aa9249e42df1a27656b470c0d4f767c0573bfd6f30ac0f482dbfb1948ec5f", 10279],
    v6Gestalt: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v6-root-gestalt.md", "36be4af93d420403b66022db7f4a29039404c6bd85773c162349be64cff0a5f5", 5598],
    v6Rejection: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v6-rejection.json", "ed35d1fc0ef93fd4e4e2bf82103aacb2ce8ac38878846763f7f55fc39d82ecf0", 3210],
    v7Artifact: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v7.json", "259d9fce299411222a126245ce22c627b260f4260d7009ecaf94ab9fbb7c0968", 21945],
    v7ManifestSchema: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v7.schema.json", "5d6f288f56298b4ac0f12b2519eb32bfecf441da324d727b66b80ba743bbe656", 12150],
    v7ShardSchema: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v7-shard.schema.json", "ae81a70365782c101b5cca2e41e7546b15c42d716f858c52063441dd19c11b20", 13812],
    v7Receipt: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v7-formation-2026-07-22.md", "5c53eb81a34c1f8d95a2aff5134403217dbf5e53bee41b7dd3b19af1556e6861", 6864],
    v7ChallengeA: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v7-challenge-a.md", "d63c351119de1732194f9134752adf0d08e85eddbb74f20fd7fa2ec0e78ec528", 14554],
    v7ChallengeB: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v7-challenge-b.md", "9308962748155124807f4ea0603d6b89dbc47673f5abd4afb070fbaeb70b185d", 7641],
    v7Gestalt: ["docs/tranches/V/apotheosis/pi/formation/occurrence-owner-v7-root-gestalt.md", "8a7dffde22dbdc68d38d92cb10484cf562386769f95d56dc23c32da92894f2f9", 4828],
    v7Rejection: ["docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v7-rejection.json", "2c77e86fabb4232f74d8ad548637206af74435122f6dce7537ee38dd37444190", 2406],
});
...
export function authenticateEvidence(repoRoot, sourceRoot, keyframesRoot) {
    ...
    const v6Rejection = JSON.parse(pinned.v6Rejection.raw.toString("utf8"));
    if (v6Rejection.subject.sha256 !== pinned.v6Artifact.sha256
        || v6Rejection.root_gestalt.sha256 !== pinned.v6Gestalt.sha256
        || !v6Rejection.challenges.every((row) => row.verdict === "REJECT")
        || !v6Rejection.confirmed_blockers.includes("six authenticated multiline bibliography and 22 multiline definition occurrences are absent")) throw new Error("v6 terminal rejection binding mismatch");
    const v7Rejection = JSON.parse(pinned.v7Rejection.raw.toString("utf8"));
    if (v7Rejection.subject.sha256 !== pinned.v7Artifact.sha256
        || v7Rejection.formation_receipt.sha256 !== pinned.v7Receipt.sha256
        || v7Rejection.root_gestalt.sha256 !== pinned.v7Gestalt.sha256
        || !v7Rejection.challenges.every((row) => row.verdict === "REJECT")
        || v7Rejection.challenges[0].sha256 !== pinned.v7ChallengeA.sha256
        || v7Rejection.challenges[1].sha256 !== pinned.v7ChallengeB.sha256) throw new Error("v7 terminal rejection binding mismatch");
