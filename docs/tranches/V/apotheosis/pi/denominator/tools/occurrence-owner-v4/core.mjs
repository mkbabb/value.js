...
const MANIFEST_SCHEMA_PATH = "docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v4.schema.json";
const SHARD_SCHEMA_PATH = "docs/tranches/V/apotheosis/pi/denominator/occurrence-owner-formation-v4-shard.schema.json";
const REPLAY_COMMAND = "node docs/tranches/V/apotheosis/pi/denominator/tools/occurrence-owner-v4/launch.mjs --source-root \"$PINNED_CSSWG_ROOT\" --keyframes-root \"$KEYFRAMES_PRIMARY_ROOT\" --output \"$OCCURRENCE_OWNER_V4_OUTPUT\"";
...
function makeManifest(evidence, tables, attestation, counterfixtures) {
    const manifest = {
        schema_version: "value.pi.full-source-occurrence-owner-formation/v4",
        date: "2026-07-22",
        ...
        validation: {
            ...
            mutation_suite: { case_count: 14, rejected: 14, digest_sha256: "0".repeat(64) },
        },
