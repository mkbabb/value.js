import { Parser, any, regex, string } from "@mkbabb/parse-that/core";
...
const commentCodePoint = Parser.lazy(() => any(
    regex(/[^*]/u),
...
export const cssTrivia = Parser.lazy(() => any(cssWhitespace, cssComment))
    .many()
    .map((parts) => parts.join(""));
