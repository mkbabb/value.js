...
function typeProof(sourceText, ts, snapshot) {
    const candidatePath = resolve("/__syntax_consume_number_g4_assay__/consume-number.ts");
    const probePath = resolve("/__syntax_consume_number_g4_assay__/.probe.ts");
...
export function verifySelf() {
    if (slash(relative(mirrorRoot, validatorFile)) !== "cells/syntax-consume-number/g4/author-admission-validator.mjs") {
