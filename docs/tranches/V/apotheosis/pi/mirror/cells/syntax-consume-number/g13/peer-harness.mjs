...
const report = { schema: "value.pi.syntax-consume-number.g13.peer-result/v1", status: "PASS", cases: corpus.cases.length, common, lanes, observations: observed.observations };
if (process.argv[2] === "--print") process.stdout.write(`${JSON.stringify(report, null, 2)}\n`);
    ...
    const actual = { schema: "value.pi.syntax-consume-number.g13.peer-expected/v1", cases: report.cases, common: report.common, lanes: report.lanes, observations_sha256: sha256(JSON.stringify(report.observations)) };
