...
type Lane = "h3-public" | "live-public" | "rejected-public" | "h3-internal" | "prior-internal";
type Manifest = {
...
const laneNames: readonly Lane[] = ["h3-public", "live-public", "rejected-public", "h3-internal", "prior-internal"];
...
function h3Public(source: string) {
...
function parseValue(lane: Lane, source: string): number | null {
    ...
    const result = lane === "h3-public" ? h3Public(source)
...
function controller(manifestPath: string, outputPath: string): void {
    ...
    const result = {
        schema: "value.pi.percentage-literal.benchmark/v4",
