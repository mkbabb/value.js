...
| **G-KFW9-2** | RED — 10 cells UNMEASURED, 9 of 10 `capability: null` | **RED, MOVED** | **9 of 10** cells carry a reading or a **named** foreclosure; only `webkit-engine` reads UNMEASURED, with its bound measured. No verdict crosses a column |
...
| **G-KFW9-13** | RED — 0 addenda, 0 PROVISIONAL | **RED, MOVED** | **12 records** now carry the addendum, **14 blocks, 13 triggers**; all PROVISIONAL with exact preconditions. The gate's *"measured value written back"* arm is untouched: **no trigger ran** |
