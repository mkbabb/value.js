...
| area picker (4 comp) | `wf_3c8798e8-23e` | 5/12 canonical on disk | **PROMOTED + RESUMED 2026-07-28 evening (ACTIVE)** into the slot core freed — `workflows/args/picker.json` byte-identical; remaining no-payload rows: componentsliders/spectrumcanvas/heroblob D/L/C |
