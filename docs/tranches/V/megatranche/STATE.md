...
| area workbenches (19) | `wf_6edda4a1-192` | 16/19 comp true | **RE-RESUMED 2026-07-29 (ACTIVE, 5th deploy)** — the 11:30pm wall killed 9 seats (wb-extract-pane, wb-mix-animationcanvas, wb-gradient-pane at 0/3); owner reset + full-redeploy order; byte-identical args, absolute child SCRIPT (L-15.9). 16 components banked incl. the fresh stopeditor corpus (touch-delete overlap, dual-axes 11px, three-owner ordering violation) |
