...
| area workbenches (19) | `wf_6edda4a1-192` | **18/19 on disk** | **RE-RESUMED 2026-07-28 ~23:50 (ACTIVE, 6th deploy)** — 5th deploy completed 16/19 claimed; another wall killed 5 seats, but disk truth shows wb-extract-pane + wb-mix-animationcanvas fully banked from prior deploys — ONLY **wb-gradient-pane (0/3)** remains. Harvest after 5th: 497 results · 5,243 defects · 747 BLOCKER (all bands); 1 payload hydrated. 6th deploy = byte-identical resume (disk args == run-record args, verified object-equal) |
| area palettes (32) | `wf_22b7a7b7-97b` | 8/32 comp true | **RE-RESUMED 2026-07-29 (ACTIVE, 5th deploy)** — same wall killed all 72 live seats again (24 components at 0/3); the 8 fresh corpora (incl. AdminUsersPanel r4: filtered-scope prune lie re-proven, 500→"No empty users" false-success, signed-out costumed as empty roster) are cached and replay |
