...
| **TRIFOLD adjudication r2** | `wf_9bd0ecd0-037` | 5 units × 3 | **RUNNING** (ColorSpaceSelector · AdminUsersPanel · ConfigSliderPane · Markdown · Dock) |
...
| area shell (12 comp) | `wf_e28d617f-9eb` | 4/72 | STOPPED — cache intact, next round |
| area workbenches (19) | `wf_6edda4a1-192` | 6/114 | STOPPED — cache intact, next round |
| area palettes (32) | `wf_22b7a7b7-97b` | 1/192 | STOPPED — cache intact, next round |
