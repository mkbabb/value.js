...
import { loadFormationRootSeedContract, loadSeedInventory, loadWaveContracts, seedRequirementProjection } from "./wave-contract.mjs";
...
let inventory;
try {
    inventory = loadSeedInventory(root);
} catch (error) {
...
if (inventory.schema !== "vnext-seed-row-inventory/3") fail("invalid inventory schema");
