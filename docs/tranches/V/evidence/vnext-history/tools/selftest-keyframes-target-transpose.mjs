...
const consumerCaptureAuthority = createConsumerImmutableCaptureAuthorityFixture({ fixtureRoot: directory });
...
function makeDeletionJudgment(repository, gitTruthBinding, gitTruth, consumer, proof, waveId = "K22T") {
    ...
    return { annex, path, decision, consumer };
}
...
try {
    ...
    const universalPositive = spawnSync(process.execPath, [
        ...
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ...
    emittedK22T = {
        ...
        consumer_capture: {
            ...
            immutable_capture: structuredClone(consumer.immutableCapture),
        },
    ...
    const universalForgery = spawnSync(process.execPath, [
        returnValidator,
        forgedUniversalPath,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ...
    const deletedRootUniversalReplay = spawnSync(process.execPath, [
        returnValidator,
        universalPath,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ], { encoding: "utf8", maxBuffer: 256 * 1024 * 1024 });
    if (deletedRootUniversalReplay.status !== 0
        || !deletedRootUniversalReplay.stdout.includes('"mode":"offline-historical-certificate"')) {
        failures.push(`K22T historical consumer snapshot replay failed after H→H+1 root removal: ${deletedRootUniversalReplay.stderr}${deletedRootUniversalReplay.stdout}`);
    }
    ...
    consumerCaptureAuthority.register(m00Consumer);
    ...
    const m00Universal = spawnSync(process.execPath, [
        returnValidator,
        m00ReturnPath,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ...
    const forgedM00Result = spawnSync(process.execPath, [
        returnValidator,
        forgedM00Path,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ...
    consumerCaptureAuthority.register(demoConsumer);
    ...
    const m10tUniversal = spawnSync(process.execPath, [
        returnValidator,
        m10tReturnPath,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
    ...
    const forgedM10TResult = spawnSync(process.execPath, [
        returnValidator,
        forgedM10TPath,
        "--historical-certificate",
        ...consumerCaptureAuthority.captureAuthorityArgs(),
