...
// Create memoized conversion functions
const memoizedColorUnit2 = useMemoize(
    (
        color: any,
        targetSpace: any,
        ...
        return colorUnit2(color, targetSpace, normalized, inverse, inplace);
    },
);
...
const NORMALIZED_COLOR_NAMES = Object.entries(COLOR_NAMES).reduce(
    (acc, [name, color]) => {
        ...
        const xyz = memoizedColorUnit2(parsedColor, "xyz", false, false, false);
