<template>
    <div class="flex flex-col relative min-w-0 w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-[var(--desktop-pane-max-w)] mx-auto h-auto max-h-full lg:max-h-[var(--content-max-h)] transition-[margin,transform] duration-300 ease-[var(--ease-standard)]">
        <Card variant="pane" class="flex flex-col rounded-2xl min-w-0 flex-none lg:flex-1 min-h-0 max-h-full overflow-hidden lg:overflow-visible transition-[box-shadow] duration-300">
