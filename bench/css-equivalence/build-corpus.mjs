...
//   node bench/css-equivalence/build-corpus.mjs [--check]   (moved from test/css/equivalence/ at X.P.W6.x)
...
const OUT = path.join(ROOT, "bench/css-equivalence/real-corpus.json");
...
const corpus = {
    ...
    note: "Generated by bench/css-equivalence/build-corpus.mjs; never hand-edited. Distinct non-empty sources, sorted; each row names every arm it came from.",
    provenance: {
