// SERVED MODEL: claude-opus-5-5 — X.P.W6.h port: VERBATIM from docs/tranches/X/parse-that/evidence/W6/retired-seam/typescript/test/css-equivalence/lib/ruled.mjs (sha256 in that tree's MANIFEST.sha256); only import paths below this line are re-pointed.
...
import { nonIdentDeclarationName } from "./adjudications.mjs";
